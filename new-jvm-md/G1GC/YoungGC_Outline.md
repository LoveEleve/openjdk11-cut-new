...
本文是 G1 Young GC 的**分析大纲**：将 Young GC 的完整流程分解为 10 个可独立分析的子模块，每个子模块对应一篇专家级分析文档；提供各子模块的分析状态追踪。

### 0.2 10 个子模块

| # | 子模块 | 核心问题 | 状态 |
|---|--------|---------|------|
| 0 | GC 触发机制 | Eden 满时如何触发 GC？ | ✅ |
| 1 | SafePoint 建立 | 如何让所有线程停止？ | ✅ |
| 2 | Pre-Evacuate | GC 前如何准备？ | ✅ |
| 3 | Root 扫描 | 如何找到所有 GC Roots？ | ✅ |
| 4 | 对象复制 | 如何并行复制存活对象？ | ✅ |
| 5 | Work Stealing | 如何实现负载均衡？ | ✅ |
| 6 | Post-Evacuate | GC 后如何清理？ | ✅ |
| 7 | 预测模型更新 | 如何更新 G1Policy？ | ✅ |
| 8 | Evacuation Failure | 空间不足时如何处理？ | ✅ |
| 9 | 堆扩展 | 何时扩展堆？ | ✅ |
